package com.ubitar.tracklytics;
...
public class TracklyticsAspect {
  ...
  @Pointcut("execution(@com.ubitar.tracklytics.TrackSuperAttribute * *(..))")
  public void methodAnnotatedWithSuperAttribute() {
    // No implementation is needed
  }

  @Pointcut("execution(@com.ubitar.tracklytics.TrackSuperAttribute *.new(..))")
  ...
  @Pointcut("execution(@com.ubitar.tracklytics.RemoveSuperAttribute * *(..))")
  public void methodAnnotatedWithRemoveSuperAttribute() {
    // No implementation is needed
  }

  @Pointcut("execution(@com.ubitar.tracklytics.RemoveSuperAttribute *.new(..))")
  ...
  @Pointcut("execution(@com.ubitar.tracklytics.TrackEvent * *(..))")
  public void methodAnnotatedWithTrackEvent() {
    // No implementation is needed
  }

  @Pointcut("execution(@com.ubitar.tracklytics.TrackEvent *.new(..))")
